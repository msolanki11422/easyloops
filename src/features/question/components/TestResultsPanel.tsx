          ...
          <div className="p-4 h-full">
            {output ? (
              <div>
                ...
                <pre className="bg-gray-50 p-3 rounded-lg text-sm font-mono text-gray-800 overflow-x-auto border">
                  {output}
                </pre>
              </div>
            ) : (
              <div className="flex items-center justify-center h-full text-gray-500">
                <div className="text-center">
                  ...
                  <p className="text-xs mt-1 text-gray-400">Run your code to see the output</p>
                </div>
              </div>
            )}
          </div>
                ...
                <div className="space-y-4">
                  ...
                  {result.passed ? (
                    <div className="flex items-center gap-2 text-green-700 bg-green-50 p-3 rounded-lg border border-green-200">
                      ...
                      <span className="text-sm font-medium">Test passed! Your output matches the expected result.</span>
                    </div>
                  ) : (
                    <div className="flex items-center gap-2 text-red-700 bg-red-50 p-3 rounded-lg border border-red-200">
                      ...
                      <span className="text-sm font-medium">Test failed. Your output doesn&apos;t match the expected result.</span>
                    </div>
                  )}
                </div>
              );
        ...
        {testResults.length === 0 && !output && (
          <div className="flex items-center justify-center h-full text-gray-500">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Click &quot;Run&quot; to execute your code and see the results</p>
            </div>
          </div>
        )}
      </div>
